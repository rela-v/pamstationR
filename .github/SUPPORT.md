# Getting help with `pamstationR`

Thank you for using `pamstationR`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/pamstationR`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/pamstationR),
...
[search issues and pull requests](https://github.com/rela-v/pamstationR/issues)
